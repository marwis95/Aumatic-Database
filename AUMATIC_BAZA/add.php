...
if (($prawa == "senior") || ($prawa == "vip") || ($prawa == "admin")){
...
//<!--========================Wypełnienie listy z typami=======================-->
	...
	$zapytanie_programista="SELECT * from uzytkownicy where login='" .  $_SESSION['user'] . "'"; //query
	...
	echo "<select name='programista' style='width: 300px'>";
		...
		while ($wiersz_programista_lista = mysql_fetch_array($wykonaj_programista_lista)){
			...
			if ($wiersz_programista['id'] == $wiersz_programista_lista['id_usera']){
	...
	//echo $zapytanie_programista_lista;
	//echo $wiersz_programista['id'];
